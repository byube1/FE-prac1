...
import {updateCustomer} from '../../redux/action/customerAction'
...
export default function DetailCustomer({ location }) {
    ...
    const editCustomer = () => {
        dispath(updateCustomer(customer.id, customer));
    }
    return (
            ...
            <Paper className={classes.paper} >
                ...
                <form className={classes.root} noValidate autoComplete="off">
                    ...
                    <Link to={{ pathname: "/manageCustomer" }}>
                        <Button onClick={editCustomer} type="submit" color="primary" variant="contained">Save</Button>
                    </Link>
